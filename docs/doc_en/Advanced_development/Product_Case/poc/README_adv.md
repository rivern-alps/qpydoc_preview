...
When deploying POC, normally, the GUI will be matched; as a result, a LCD is needed. As for the LCD driver, you can refer to （[Application notes on LCD](/docsite/en-us/docs/Advanced_development/Component/QuecPythonSub/LCD_adv.html)）
...
​		（1）Compile the driver of corresponding LCD, please refer to （[Application notes on LCD](/docsite/en-us/docs/Advanced_development/Component/QuecPythonSub/LCD_adv.html)）
