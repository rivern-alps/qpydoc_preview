...
Please refer to the wiki on QuecPython official website: [BLE API  illustration](https://python.quectel.com/wiki/#/en-us/api/QuecPythonClasslib?id=ble-bluetooth-low-energy).

## Normal development procedure of BLE Server and Client

### BLE Server Procedure

![BLE_01(E)](media/BLE_Server_en.png)

### BLE Client Procedure

![BLE_02(E)](media/BLE_Client_en.png)
